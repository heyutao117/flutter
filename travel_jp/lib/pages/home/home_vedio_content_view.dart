...
class HYVideoContentView extends StatefulWidget {
  ...
  HYVideoContentView({Key? key, required this.vid,required this.homeDataVideoModelEntity}) : super(key: key);
        ...
        children: [
          Padding(
            ...
            child: SizedBox(
              ...
              child: AspectRatio(
                  aspectRatio: 2,
                  child:_controller.value.isInitialized?  Chewie(controller: _chewieController,):const Center(
                    child:CircularProgressIndicator() ,
                  )
              ),
            ),
          ),
          Container(padding: const EdgeInsets.only(left: 12),alignment: Alignment.centerLeft,child: const Text("节目列表",style: TextStyle(fontSize: 20),)),
          Expanded(
            child: ListView.builder(
                ...
                itemBuilder:(context,index){
                  return getCardWidget(widget.homeDataVideoModelEntity.vlist[index], context);
                }
            ),
          ),
        ]
        ...
        children: [
          GestureDetector(
            ...
            child: Stack(
              ...
              children: [
                Image.network(vlist.backImg,height: 100,fit: BoxFit.fitHeight,),
                Align(
                  alignment: Alignment.center,
